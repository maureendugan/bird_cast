...
<em>Maureen Dugan and Liz Tom</em>
...
* Then, if another user's handle is mentioned in the tweet, send that user a notification email.
------ Known Issues --------
The mention function is not specific enough. Add @handle requirements if you want to mention a user.
------ Next Stories --------
